...
import type {
  ScoresClient as _scores_ScoresClient,
  ScoresDefinition as _scores_ScoresDefinition
} from './scores/Scores';
...
export interface ProtoGrpcType {
  scores: {
    ...
    Scores: SubtypeConstructor<typeof grpc.Client, _scores_ScoresClient> & {
      service: _scores_ScoresDefinition;
    };
