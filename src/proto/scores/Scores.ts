...
import type { AggregateCategorydScoresResponse as _scores_AggregateCategorydScoresResponse, AggregateCategorydScoresResponse__Output as _scores_AggregateCategorydScoresResponse__Output } from '../scores/AggregateCategorydScoresResponse';
...
export interface ScoresClient extends grpc.Client {
  GetAggregatedCategoryScores(argument: _scores_TimeRangeRequest, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_scores_AggregateCategorydScoresResponse__Output>;
  GetAggregatedCategoryScores(argument: _scores_TimeRangeRequest, options?: grpc.CallOptions): grpc.ClientReadableStream<_scores_AggregateCategorydScoresResponse__Output>;
  getAggregatedCategoryScores(argument: _scores_TimeRangeRequest, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_scores_AggregateCategorydScoresResponse__Output>;
  getAggregatedCategoryScores(argument: _scores_TimeRangeRequest, options?: grpc.CallOptions): grpc.ClientReadableStream<_scores_AggregateCategorydScoresResponse__Output>;
  ...
  GetScoresByTicket(argument: _scores_TimeRangeRequest, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_scores_ScoresByTicketResponse__Output>;
  GetScoresByTicket(argument: _scores_TimeRangeRequest, options?: grpc.CallOptions): grpc.ClientReadableStream<_scores_ScoresByTicketResponse__Output>;
  getScoresByTicket(argument: _scores_TimeRangeRequest, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_scores_ScoresByTicketResponse__Output>;
  getScoresByTicket(argument: _scores_TimeRangeRequest, options?: grpc.CallOptions): grpc.ClientReadableStream<_scores_ScoresByTicketResponse__Output>;
...
export interface ScoresHandlers extends grpc.UntypedServiceImplementation {
  GetAggregatedCategoryScores: grpc.handleServerStreamingCall<_scores_TimeRangeRequest__Output, _scores_AggregateCategorydScoresResponse>;
  ...
  GetScoresByTicket: grpc.handleServerStreamingCall<_scores_TimeRangeRequest__Output, _scores_ScoresByTicketResponse>;
  
}

export interface ScoresDefinition extends grpc.ServiceDefinition {
  GetAggregatedCategoryScores: MethodDefinition<_scores_TimeRangeRequest, _scores_AggregateCategorydScoresResponse, _scores_TimeRangeRequest__Output, _scores_AggregateCategorydScoresResponse__Output>
